...
public class CourseTest {
    ...
    public void setup() {
        ...
        lecturer = new Lecturer("Azubike", "Azu", "azulolo", "12345", "B412");
    ...
    public void addLecturer() {
        ...
        Lecturer newLecturer = new Lecturer("Ade","Ife","temo","1223", "B402");
    ...
    public void removeLecturer() {
        ...
        Lecturer newLecturer = new Lecturer("AdeSecond","Ife","temo","1223","C401");
        course.addLecturer(newLecturer);
