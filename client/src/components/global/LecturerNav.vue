    ...
    <div class="NavBar">
        <div class="container">
            <nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark justify-content-between"
                ...
                <router-link class="navbar-brand" :to="'/'+role">
                    {{role}} HOME
                    <span class="status mobile" :class="{'online': lecturer.inOffice===true, 'offline': lecturer.inOffice===false}"></span>
                </router-link>
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li v-if="isLoggedIn" class="nav-item dropdown" :class="{show: showCourse}">
                            ...
                            <div v-if="isLoggedIn && role.toLowerCase() === 'lecturer'" class="dropdown-menu"
                                ...
                                <router-link class="dropdown-item" tag="a" to="/lecturer/courses"> Add Course</router-link>
                            </div>
                        </li>
                    </ul>
